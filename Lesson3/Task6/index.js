...
const activeUser = anotherUser || defaultUserName /* Operator OR*/
console.log(activeUser)
const hasAccess = isAdmin || isLoggedIn //Operator OR
console.log(hasAccess)
const isTruthy = message && !!anotherMessage //Надо проверить условие
